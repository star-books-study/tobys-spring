...
- 다음은 트랜잭션과 같은 부가적인 기능을 **위임**을 통해 외부로 분리했을 때의 결과이다.
...
- 트랜잭션 기능은 비즈니스 로직과는 성격이 달라 아예 밖으로 분리할 수 있다. 부가기능 전부를 핵심 코드가 담긴 클래스에서 독립 시킬 수 있다. (UserServiceTx, UserServiceImpl)
